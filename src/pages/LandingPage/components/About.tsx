...
export default function About() {
  ...
  return (
    <section id="about" className='h-screen bg-gradient-to-b  flex items-center flex-col mb-32'>
      ...
      <div className='flex items-center p-page my-12'>
        <img className='w-1/3 p-6' src="https://imgs.search.brave.com/pgZTFUu2a6KKHh7NOuOdLYWtrYhetSnskVvx1yoPPQg/rs:fit:1200:1200:1/g:ce/aHR0cHM6Ly92aXNp/b24udW5pcHYuaXQv/Rm90b0xhYi8xLmpw/Zw"></img>
