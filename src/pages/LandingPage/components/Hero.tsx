...
const slides = [
  <div
    className="w-screen h-screen bg-[url('https://imgs.search.brave.com/-Jfcq2fVUs5AHB9u_hftrHExgkw34coDzPBVPbZ4ry4/rs:fit:1200:900:1/g:ce/aHR0cHM6Ly93d3cu/bmF2YXJyb2NvbGxl/Z2UuZWR1L3dwLWNv/bnRlbnQvdXBsb2Fk/cy8yMDE0LzAyL2Nv/bXB1dGVyLWxhYi5q/cGc')] 
  ...
  >
    ...
    <div className="text-center z-[2] flex flex-col items-center gap-y-6">
      ...
      <p className="font-light text-sm text-back bg-background bg-opacity-30 px-10 py-6 w-2/3 rounded-lg" style={{ textShadow: '0px 0px 5px #000000' }}>
...
export default function Hero() {
  ...
  return (
    <section id="hero" className="h-screen relative bg-cover overflow-hidden">
      <div
